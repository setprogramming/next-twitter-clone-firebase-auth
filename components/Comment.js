...
export default function Comment({comment, commentId, originalPostId}) {
  ...
  return (
    <div className="flex p-3 cursor-pointer border-b border-gray-200 pl-20">
        {/* User image */}
        <img src={comment?.userImg} alt="profile-picture" className="h-10 w-10 rounded-full mr-4" />
        ...
        <div className="flex-1">
            ...
            <div className="flex items-center justify-between text-gray-500 p-2">
                ...
                <div className="flex items-center">
                    {hasLiked ? (
                        <HeartIconFilled onClick={likeComment} className="h-9 w-9 hoverEffect p-2
                        text-red-600 hover:bg-red-100" />
                    ) : (
                        <HeartIcon onClick={likeComment} className="h-9 w-9 hoverEffect p-2
